...
buildah run $container -- /root/.conda/envs/gpcam/bin/pip install redis zmq
...
buildah run -v /vagrant/gpcamv4and5:/usr/local/share/gpcam $container -- /root/.conda/envs/gpcam/bin/pip install /usr/local/share/gpcam
